var conf = {
  ...
  appid: '',
  // 神策分析数据接收地址
  server_url: 'https://melonblock.datasink.sensorsdata.cn/sa?token=08fcc11f3a83a683&project=melon',
  //melonblock.cloud.sensorsdata.cn:8006/config/?project=melonsadac3b0fc
  //sensorsdata.melonblock.com/sa?project=default&token=08fcc11f3a83a683
  ...
  // 是否自动采集如下事件（建议开启）
  autoTrack:{  
    appLaunch:false, //是否采集 $MPLaunch 事件，true 代表开启。
    appShow:false, //是否采集 $MPShow 事件，true 代表开启。
    appHide:false, //是否采集 $MPHide 事件，true 代表开启。
